...
def _render_readme_text(*, n_videos: int, n_first_images: int, n_models: int) -> str:
    ...
    return (
        ...
        "  [`tools/build_snapshot.py`](https://github.com/NU-World-Model-Embodied-AI/PhyGround/blob/master/tools/build_snapshot.py).\n"
        "\n"
        "## Layout\n"
        "\n"
        "```\n"
        ...
        "## Source & rebuild\n"
        "\n"
        "Generated by <https://github.com/NU-World-Model-Embodied-AI/PhyGround>. The\n"
        "manifest of every file in this dataset is checked into that repo at\n"
        "[`snapshot/HF_UPLOAD_MANIFEST.json`](https://github.com/NU-World-Model-Embodied-AI/PhyGround/blob/master/snapshot/HF_UPLOAD_MANIFEST.json),\n"
